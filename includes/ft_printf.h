...
/*   Updated: 2020/10/09 18:18:59 by oem              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					type_d_i(va_list args, t_flag *flags);
int					type_o_u(va_list args, t_flag *flags);
int					type_f(va_list args, t_flag *flags);
int					type_c(va_list args, t_flag *flags);
int					type_s(va_list args, t_flag *flags);
